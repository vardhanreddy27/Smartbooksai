  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
        <div className="absolute h-44 w-44 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/35 blur-2xl left-[var(--mx)] top-[var(--my)]" />
      </div>
...
function InvoiceMockup() {
  return (
    <div className="absolute bottom-5 right-5 w-[168px]  shadow-[0_18px_40px_rgba(15,23,42,0.12)] transition duration-500 group-hover:-translate-y-3 group-hover:rotate-1 overflow-hidden">
      <img
        src="/reciept.png"
        alt="Receipt"
...
function MobileExpenseMockup() {
  return (
    <div className="absolute top-5 right-5 w-[148px] transition-all duration-700 ease-out group-hover:-translate-y-6 group-hover:scale-105 group-hover: overflow-hidden">
      <img
        src="/expenses.png"
        alt="Expenses"
...
function PayrollMockup() {
  return (
    <div className="absolute bottom-5 right-5 w-[210px]   transition-all duration-700 ease-out group-hover:-translate-y-6 group-hover:scale-105 group-hover: overflow-hidden">
      <img
        src="/payrollimg.png"
        alt="Payroll"
        className="w-full h-auto object-cover"
  ...
  return (
    <section className="relative overflow-hidden bg-white px-5 py-20">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-20 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[#5244a7]/8 blur-[120px]" />
      </div>

      <div className="relative z-10 px-20">
        <div className="mx-auto max-w-[620px] text-center">
          <h2 className="text-[32px] font-black leading-[1.05] tracking-[-1.2px] text-slate-950 sm:text-[44px]">
            The features you need.
            <span className="block text-[#5244a7]">All in one place.</span>
          </h2>

          <p className="mx-auto mt-4 max-w-[560px] text-[15px] font-medium leading-7 text-slate-600">
            SmartBooks AI brings invoices, payments, expenses, payroll, bank
            sync, and AI reports into one simple accounting system.
          </p>
        </div>

        <div className="mt-12 grid auto-rows-[230px] grid-cols-1 gap-5 md:grid-cols-6 lg:grid-cols-12">
          {/* Invoicing */}
          <BentoCard className="bg-[#fff8e8] p-7 md:col-span-3 lg:col-span-5">
          ...
          <BentoCard className="bg-[#5244a7] p-7 text-white md:col-span-3 lg:col-span-7">
          ...
          {/* Expenses */}
          <BentoCard className="bg-[#eef7ff] p-7 md:col-span-2 lg:col-span-4">
          ...
          {/* Payroll */}
          <BentoCard className="bg-[#06162f] p-7 text-white md:col-span-2 lg:col-span-4">
            <div className="relative z-20 max-w-[140px]">
          ...
          {/* More Features */}
          <BentoCard className="bg-[#ffc928] p-7 md:col-span-2 lg:col-span-4">
